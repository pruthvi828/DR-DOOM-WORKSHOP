...
export function App() {
  ...
  // ====================================================================
  // TODO: [MISSION 5] SET YOUR ASSISTANT'S DEFAULT VOICE ID
  // Examples: "en-US-GuyNeural", "en-GB-RyanNeural", "en-GB-SoniaNeural"
  // ====================================================================
  ...
  async function startListening() {
    ...
    try {
      ...
      recorder.onstop = () => {
        ...
        stopCapture();
        // ====================================================================
        // TODO: [MISSION 4] ADJUST PUSH-TO-TALK MINIMUM HOLD THRESHOLD
        // Default is 650ms. Lowering to 400ms makes hold-to-talk more responsive!
        // ====================================================================
        if (duration < 650) {
  ...
  return <main className="app-shell">
    ...
    <MovablePanel id="conversation" label="Jarvis conversation" className="chat-panel" defaultPosition={panelPositions.current.chat}>
      ...
      {/* ====================================================================
          TODO: [MISSION 1] CUSTOMIZE ASSISTANT BRANDING & WELCOME MESSAGE
          Change "UNNAMED ASSISTANT" to your custom codename and tagline!
          ==================================================================== */}
      <p className="jarvis-brand">UNNAMED ASSISTANT</p><h1>System unconfigured.</h1><p className="connection-state">{stateLabel}</p>
